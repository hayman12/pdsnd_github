...
def get_filters():
    ...
    """
    print('Hello! Let\'s explore some bikeshare data for three major American cities!')
    ...
    while True:
        day = input(
            'Which day of the week would you like to see data for? For the whole week, answer \'all\':\n ').lower().title()
